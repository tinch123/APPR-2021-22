...
print(graf4)
```
Tudi tukaj v zadnjem letu vidimo rast cen hrane, pijače, zdravstva prevoza ter predvsem v prevozu (ki je leta 2020 precej pade zaradi padca cen goriva in nafte med korono). Trend je toraj podoben kot je bil povprečno v evropskih državah. Vidimo pa, da je v zadnjem letu padla cena za rekreacijo ali kulturo (najbrž zato, ker letos ni več turističnih bonov) in pa za komunikacije.
...
```{r zemljevid.evrope3, echo=FALSE, fig.align='center', message=FALSE, warning=FALSE, fig.cap='Zemljevid 3'}
 zemljevid.evrope3()
```
Inflacijski indeks se je kot pričakovano glede na prejšnji graf zelo povišal v Turčiji, še bolj pa se je v Argentini, kar pa žal ne moremo primerjati s prejšnjim grafom, saj tam nimamo podatkov za Argentino. Vidimo, da se je inflacijski indeks znižal na Norveškem.
